...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    if (showDashboard) return <Dashboard setActiveTab={handleTabChange} />;
    
    switch (activeTab) {
      case AppTab.QURAN: return <QuranExplorer />;
      case AppTab.HADITH: return <HadithVault />;
      case AppTab.DEVELOPER: return <Developer />;
      case AppTab.ABOUT: return <About />;
      case AppTab.QURAN_AI: return <AIScholar />;
      case AppTab.LIBRARY: return <Library />;
      case AppTab.TOOLS: return <Tools />;
      case AppTab.ART_STUDIO: return <ArtStudio />;
      default: return <QuranExplorer />;
    }
  };
